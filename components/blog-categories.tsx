    ...
    return (
        <>
            <div className="flex justify-center mt-10">
                <h3 className="bg-gradient-to-b from-black/80 to-black/20 bg-clip-text text-transparent drop-shadow-2xl text-2xl tracking-tight sm:text-4xl italic px-3 pb-3">blog series</h3>
            </div>
            <div className="md:mx-10 flex justify-center flex-col">
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <Link
                        href='https://blog.jeremyquinto.com/series/spotify-project' 
                        className="h-full grid gap-1 hover:bg-gray-100/50 transition-all hover:shadow-md p-3 rounded-xl"
                        target="_blank"
                        aria-label="billboardify series"
                    >
                        <h3 className="text-xl font-bold tracking-tight">🎶 billboardify</h3>
                        <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                            articles explaining how i built billboardify
                        </p>
                        <p className="mt-4 text-sm text-lime-700 group-hover:underline ml-auto">see series →</p>
                    </Link>
                    <Link
